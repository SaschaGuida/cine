        ...
        const extractedMovies = [
          {
            id: response.id,
            title: response.name,
            plot: 'Pokemon plot goes here',
            posterUrl: response.sprites.front_default,
          },
        ];
